...
const setEventsToCard = (cardItem, owner = false) => {
  ...
  const cardLikeButton = cardItem.querySelector(
    config.cards.likeButtonSelector
  );
  const cardLikesCount = cardItem.querySelector(
    config.cards.likesCountSelector
  );
  const cardRemoveButton = cardItem.querySelector(
...
export const createCard = (cartItem) => {
  ...
  const clonedCard = cardNodeContent
  ...
  clonedCard.querySelector(config.cards.nameSelector).textContent =
    cartItem.name;
  ...
  clonedCard.querySelector(config.cards.likesCountSelector).textContent =
    cartItem.likes.length;
